...
public class Main {
    static ArrayList<Barang> gudang = new ArrayList<>();
        ...
        while (true) {
            ...
            switch (pilih) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    System.out.println("Keluar dari Aplikasi Gudang");
                    return;
                default:
